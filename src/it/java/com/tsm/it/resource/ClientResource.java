...
import static com.tsm.template.util.BaseDTOTest.getRandomInt;
...
public class ClientResource extends BaseItResource {
    ...
    public ClientResource status() {
        return status(Client.ClientStatus.values()[getRandomInt(0, Client.ClientStatus.values().length - 1)].name());
    }
